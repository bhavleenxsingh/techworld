...
<div class="container">
    ...
    <div class="mb-3">
        ...
        <input type="radio" name="gender" value="Male" {{ old('gender', isset($address) ? $address->gender : '') == 'Male' ? 'checked' : '' }}> Male &nbsp;&nbsp;    
        <input type="radio" name="gender" value="Female" {{ old('gender',isset($address) ? $address->gender : '') == 'Female' ? 'checked' : ''}}> Female &nbsp;&nbsp;    
        <input type="radio" name="gender" value="Other" {{ old('gender', isset($address) ? $address->gender : '') == 'Other' ? 'checked' : '' }}> Other
        <span class="text-danger">
            @error('gender')
                {{$message}}
            @enderror
